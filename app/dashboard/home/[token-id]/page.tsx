    ...
    <div className="app-container">
        ...
        <div className="wallet-container">
            ...
            <div className="token-detail-container">
                <div className="token-detail-close">
                ...
                <div className="token-detail-container-title">
                    ...
                    <h2 className="token-detail-quantity top-8px">
                        950000
                    </h2>
                    <div className="top-20px token-detail-token-contract-address-title">
                        <strong>Token name</strong>
                    </div>
                    <div className="token-detail-token-contract-address top-8px">
                        MyTokenERC20
                    </div>
                    <div className="top-20px token-detail-token-contract-address-title">
                    ...
                    <div className="token-detail-token-contract-address top-8px">
                        0x29ed8cE3cA1CcF72838AdC691726603b42d8b799
                    </div>
                    <div className="top-20px token-detail-token-network-title">
                        <strong>Network:</strong>
                    </div>
                    <div className="token-detail-token-network top-8px">
                        Sepolia test network
                    </div>
                </div>

                <div className="top-20px wallet-coin-option-item token-detail-token-send flex-row">
                    <div className="wallet-coin-option-button flex-row">
                        <i className="fa-solid fa-arrow-up wallet-coin-option-button-send"></i>
                    </div>
                <span>Send</span>
                </div>
                <div className="top-20px top-20px network-select-add">
