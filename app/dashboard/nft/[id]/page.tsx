    ...
    <div className="app-container">
        ...
        <div className="wallet-container">
            <div className="wallet-container-header flex-row">
                ...
                <div className="wallet-account flex-row">
            ...
            <div className="nft-detail-container">
                <div className="nft-detail-close">
                    <i className="fa-solid fa-xmark"></i>
                </div>
                <div className="nft-detail-contract flex-row">
                    <div className="nft-detail-contract-title">
                        <strong>Contract address</strong>
                    </div>
                    <div className="nft-detail-contract-address">
                        0x84f94...b7e3f
                    </div>
                </div>

                <img src="../default_nft.png" alt="MyNFT" className="nft-detail-image" />

                <div className="nft-detail-tokenid">
                    #2002
                </div>

                <button className="nft-detail-send">Send</button>

                <div className="nft-detail-send-effect-container">
                    <div className="nft-detail-send-effect">View on Opensea</div>
                </div>

                <div className="nft-detail-send-effect-container">
                    <div className="nft-detail-send-effect">Remove NFT</div>
                </div>
            </div>
        </div>
    </div>
