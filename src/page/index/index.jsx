    ...
    <div className=" items-center justify-center flex flex-col text-center bg-black h-max">
      ...
      <div className="bg-backgroundColor w-[1000px] items-center h-full">
        <div className="relative py-[26px] px-[16px]  flex items-center justify-between">
          <div
            className="bg-black py-[6px] rounded-3xl px-3 flex  items-center justify-center"
            onClick={() => {
        ...
        <div className="wallet-container-activity">
          <div className="shadow-md py-4 px-6 relative flex items-center justify-center">
            <div
              ...
              className={`w-1/3 pb-2.5 ${
                tabIndex == 0 ? "border-b-2 border-orangered mr-5" : ""
              }  `}
            >
              Chain Analytics
            </div>
            <div
              ...
              className={`w-1/3 pb-2.5 ${
                tabIndex == 1 ? "border-b-2 border-orangered mr-5" : ""
              }  `}
            >
              Tokens
            </div>
            <div
              ...
              className={`w-1/3 pb-2.5 ${
                tabIndex == 2 ? "border-b-2 border-orangered mr-5" : ""
              }  `}
            >
              Activitys
            </div>
